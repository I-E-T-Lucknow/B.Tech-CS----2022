...
class Attirefitin(data.Dataset):
    def __init__(self, opt):
        super(Attirefitin, self).__init__()
        ...
        with open(osp.join(opt.dataset_dir, opt.dataset_list), 'r') as f:
            for line in f.readlines():
                print('Image_name Cloth_name:',line)
    ...
    def __getitem__(self, index):
        ...
        parse = parse.convert('P', colors = 8, palette=Image.ADAPTIVE)  ###################################
        # print(parse)                  #####################################
...
class AttirefitinDataLoader:
    def __init__(self, opt, dataset):
        super(AttirefitinDataLoader, self).__init__()
